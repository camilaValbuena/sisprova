...
<html lang="en">
	...
	<body class="no-skin">
		...
		<div class="main-container ace-save-state" id="main-container">
			...
			<!-- CONTENEDOR ELEMENTOS PLANTILLA -->
			<div class="main-content">
				<div class="main-content-inner">
					<div class="col-md-12 well">
						@if(Session::get('msj1'))
							<div class="col-md-12 alert msj1 text-center">
								<h3>{{Session::get('msj1')}} <i class="fa fa-check fa-lg" aria-hidden="true"></i></h3>
							</div>
 			...
 			<!--FIN CONTENEDOR ELEMENTOS PLANTILLA -->

			<div class="footer">
				<div class="footer-inner">
					<div class="footer-content">
						<span class="bigger-120">
							<span class="blue bolder">Sisprova</span>
		...
		<!-- SCRIPTS TABLAS JQUERY -->
		<script src="assets/js/jquery.dataTables.min.js"></script>
		<!-- FIN SCRIPTS TABLAS JQUERY -->
